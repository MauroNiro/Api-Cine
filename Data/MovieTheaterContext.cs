        ...
        : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Movie>().HasData(
                new { MovieId = 1, MovieName = "Star Wars ep1", DirectorId = 1, IsNational = false, Length = 120, MovieImg = "https://static.wikia.nocookie.net/esstarwars/images/7/75/EPI_TPM_poster.png/revision/latest/scale-to-width-down/1000?cb=20240316183455" },
